...
class adsethelper{
 ...
 public function getAdVideos(){
  ...
  $adsets = $adaccount->getAdVideos($fields, array());
  echo "---------------------------------------------------------------------------"."<br>";
  print_r($adsets->getResponse()->getContent()['data']);
  return $adsets->getResponse()->getContent()['data'];
 }
 ...
 public function createAdSetHtml(){
  ...
  $s = $s."<input type=\"hidden\" name=\"type\" value=\"adgroup\">"."\n";
  $s = $s."<input type=\"hidden\" name=\"spec_type\" value=\"video_views\">"."\n";
  $s = $s."Ad name  : "."\n";
  $s = $s."<input type=\"text\" name=\"ad_name\"><br>"."\n";
  $s = $s."Adcreative name : "."\n";
  $s = $s."<input type=\"text\" name=\"adcreativename\"><br>"."\n";
  $s = $s."Ad header  : "."\n";
  $s = $s."<input type=\"text\" name=\"ad_header\"><br>"."\n";
  ...
  $s = $s."Select the videos : "."\n";
  $s = $s."<select name=\"video_id\">"."\n";
  $videos = self::getAdVideos();
  foreach ($videos as $video){
        $s = $s. "<option value=".$video['id'].">".$video['name']."</option>"."\n";
  }
  $s = $s."</select> <br>"."\n";

  $s = $s."Video location : "."\n";
  $s = $s."<input type=\"text\" name=\"video_location\"><br>"."\n";
