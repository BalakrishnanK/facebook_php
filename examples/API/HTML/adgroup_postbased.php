...
class adsethelper{
 ...
 public function getAdPagePosts(){
 ...
 public function createAdSetHtml(){
  ...
  $s = $s."<input type=\"hidden\" name=\"spec_type\" value=\"post_based\">"."\n";
  $s = $s."Ad name  : "."\n";
  ...
  $s = $s."Select Ad set"."\n";
  $s = $s."<select name=\"object_story_id\">"."\n";
  $pageposts = self::getAdPagePosts();
  foreach ($pageposts as $pagepost){
        $s = $s. "<option value=".$pagepost['id'].">".$pagepost['name']."</option>"."\n";
  }
  $s = $s."</select> <br>"."\n";
