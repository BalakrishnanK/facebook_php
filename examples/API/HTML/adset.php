...
class adsethelper{
 ...
 public function createAdSetHtml(){
  ...
  $s = $s. "<option value=".BidTypes::BID_TYPE_ABSOLUTE_OCPM.",ACTIONS".">Clicks to website </option>"."\n";
  $s = $s. "<option value=".BidTypes::BID_TYPE_ABSOLUTE_OCPM.",REACH".">Daily unique Reach</option>"."\n";
  $s = $s. "<option value=".BidTypes::BID_TYPE_CPC.">Clicks </option>"."\n";
  $s = $s. "<option value=".BidTypes::BID_TYPE_CPM.">Impressions</option>"."\n";
  $s = $s."</select> <br>"."\n";
  $s = $s."Bid value"."\n";
